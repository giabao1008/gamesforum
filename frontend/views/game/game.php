        ...
        <div class="col-md-7 wthree_blog_left">
            <div class="wthree_blog_left_grid">
                ...
                <ul>
                    ...
                    <li><span class="glyphicon glyphicon-heart" aria-hidden="true"></span><a href="#"><?= $game->views_count?></a><i>|</i></li>
...
<!--            </div>-->
            ...
            <div class="w3agile_flickr_posts">
                ...
                <div class="w3agile_flickr_post_left">
                    <a href="single.html"><img src="http://gamesforum.vn/backend/web/uploads/<?= $same->logo; ?>" alt=" " class="img-responsive" /></a>
                </div>
                <?php }?>
